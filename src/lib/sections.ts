...
export const SECTION_FIELDS: Record<SectionType, FieldDef[]> = {
  ...
  event: [
    ...
    { key: "_h_venue_photos", label: "Fotos do local", type: "heading" },
    { key: "venue_photo_1", label: "Foto 1", type: "image" },
    { key: "venue_photo_2", label: "Foto 2", type: "image" },
    { key: "venue_photo_3", label: "Foto 3", type: "image" },
    { key: "venue_photo_4", label: "Foto 4", type: "image" },
    {
      key: "venue_photos_mode",
  ...
  location: [
    ...
    { key: "address", label: "Endereço", type: "text" },
    { key: "map_url", label: "Link do mapa", type: "url" },
    { key: "_h_map", label: "Mapa", type: "heading" },
    { key: "show_map", label: "Mostrar mapa do Google Maps", type: "switch", fallback: true },
    {
      key: "map_height",
    ...
    },
    {
      ...
      fallback: "15",
      options: [
        { value: "12", label: "Cidade" },
        { value: "15", label: "Bairro" },
        { value: "17", label: "Rua" },
      ],
    },
    { key: "_h_weather", label: "Previsão do tempo", type: "heading" },
    {
      key: "show_weather",
      label: "Mostrar previsão do tempo para o dia",
      type: "switch",
      fallback: true,
    },
    SPACING_FIELD,
